...
static void MX_ADC2_Init(void)
{
  ...
  */
  ...
  LL_GPIO_Init(V_SENSE_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = CUR_SENSE_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(CUR_SENSE_GPIO_Port, &GPIO_InitStruct);
...
static void MX_UART4_Init(void)
{
  ...
  */
  ...
  UART_InitStruct.BaudRate = 416666;
...
static void MX_UART5_Init(void)
{
  ...
  */
  ...
  /* UART5_RX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_STREAM_4, LL_DMAMUX1_REQ_UART5_RX);
...
void MPU_Config(void)
{
  ...
  */
  LL_MPU_ConfigRegion(LL_MPU_REGION_NUMBER0, 0x00, 0x24000000, LL_MPU_REGION_SIZE_32KB|LL_MPU_TEX_LEVEL0|LL_MPU_REGION_FULL_ACCESS|LL_MPU_INSTRUCTION_ACCESS_DISABLE|LL_MPU_ACCESS_SHAREABLE|LL_MPU_ACCESS_NOT_CACHEABLE|LL_MPU_ACCESS_NOT_BUFFERABLE);
  /* Enables the MPU */
