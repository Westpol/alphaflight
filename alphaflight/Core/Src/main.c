...
int main(void)
{
  ...
  SERVO_INIT(TIM2, TIM3);

  SERVO_SET_PWM(0, 1100);
  SERVO_SET_PWM(1, 1200);
  SERVO_SET_PWM(2, 1300);
  SERVO_SET_PWM(3, 1400);
  SERVO_SET_PWM(4, 1600);
  SERVO_SET_PWM(5, 1600);
  SERVO_SET_PWM(6, 1700);
  SERVO_SET_PWM(7, 1800);
  ...
  CRSF_SET_PARSER_TASK_PID(SCHEDULER_REGISTER_TASK(CRSF_PARSE_DMA, 100, false, 50, 150, 50, "CRSF Parsing"));
  GPS_SET_PARSER_TASK_PID(SCHEDULER_REGISTER_TASK(GPS_PARSE_DMA, 100, false, 50, 150, 50, "GPS Parsing"));
...
static void MX_TIM8_Init(void)
{
  ...
  /* TIM8_UP Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_STREAM_1, LL_DMAMUX1_REQ_TIM8_UP);
...
static void MX_TIM23_Init(void)
{
  ...
  LL_TIM_SetTriggerOutput(TIM23, LL_TIM_TRGO_RESET);
  LL_TIM_DisableMasterSlaveMode(TIM23);
...
static void MX_TIM24_Init(void)
{
  ...
  TIM_InitStruct.Autoreload = 4294967295;
  TIM_InitStruct.ClockDivision = LL_TIM_CLOCKDIVISION_DIV1;
  LL_TIM_Init(TIM24, &TIM_InitStruct);
  LL_TIM_DisableARRPreload(TIM24);
  LL_TIM_SetClockSource(TIM24, LL_TIM_CLOCKSOURCE_INTERNAL);
  LL_TIM_SetTriggerOutput(TIM24, LL_TIM_TRGO_RESET);
  LL_TIM_DisableMasterSlaveMode(TIM24);
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOC, MAGNETO_CS_Pin|IMU_CS_Pin);
  ...
  /**/
  LL_GPIO_SetPinPull(BARO_EXTI_GPIO_Port, BARO_EXTI_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(MAGNETO_EXTI_GPIO_Port, MAGNETO_EXTI_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(IMU_EXTI_2_GPIO_Port, IMU_EXTI_2_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(IMU_EXTI_1_GPIO_Port, IMU_EXTI_1_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(POWER_GOOD_EXTI_GPIO_Port, POWER_GOOD_EXTI_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinMode(BARO_EXTI_GPIO_Port, BARO_EXTI_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(MAGNETO_EXTI_GPIO_Port, MAGNETO_EXTI_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(IMU_EXTI_2_GPIO_Port, IMU_EXTI_2_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(IMU_EXTI_1_GPIO_Port, IMU_EXTI_1_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(POWER_GOOD_EXTI_GPIO_Port, POWER_GOOD_EXTI_Pin, LL_GPIO_MODE_INPUT);
  ...
  /**/
  GPIO_InitStruct.Pin = MAGNETO_CS_Pin|IMU_CS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
...
void MPU_Config(void)
{
  ...
  */
  LL_MPU_ConfigRegion(LL_MPU_REGION_NUMBER0, 0x00, 0x24000000, LL_MPU_REGION_SIZE_32KB|LL_MPU_TEX_LEVEL1|LL_MPU_REGION_FULL_ACCESS|LL_MPU_INSTRUCTION_ACCESS_DISABLE|LL_MPU_ACCESS_NOT_SHAREABLE|LL_MPU_ACCESS_NOT_CACHEABLE|LL_MPU_ACCESS_NOT_BUFFERABLE);
  /* Enables the MPU */
